...
public class statements_level2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What is is the output of the Java program? \\n\" +\n" +
                "                        \"int marks=85;\\n\" +\n" +
                "                        \"if(marks >= 80)\\n\" +\n" +
                "                        \"System.out.println(\\\"DISTINCTION\\\")\\n\" +\n" +
                "                        \"else if(marks >=35)\\n\" +\n" +
                "                        \"System.out.println(\\\"PASS\\\")");
        questionC.setAnswer1("PASS");
        questionC.setAnswer2("Compiler error");
        questionC.setAnswer3("None - are the false answers - explanation - It is okay to skip the ELSE statement.");
        questionC.setRightAnswer("DISTINCTION");
        ...
        questionBar.setText("");
        level.setText("Statements - Level 2");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("3rowSoftwareQuestions").child("question2").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), statements_level3.class));
                dialog.dismiss();
            }
        });
