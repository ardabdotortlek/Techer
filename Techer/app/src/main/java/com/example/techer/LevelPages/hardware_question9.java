...
public class hardware_question9 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which device can understand difference between data & programs?");
        questionC.setAnswer1("Mouse");
        questionC.setAnswer2("HDD");
        questionC.setAnswer3("Memory");
        questionC.setRightAnswer("Microprocessor");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 9");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question10.class));
                dialog.dismiss();
            }
        });
