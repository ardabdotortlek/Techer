...
public class hardware_question6 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("One of the major components of a PC is the Central Processing Unit (CPU) which can be best described as:");
        questionC.setAnswer1("The device that sends the monitor signals telling it what to display");
        questionC.setAnswer2("The area that regulates all of the system power usage");
        questionC.setAnswer3("The area where all the of the Basic input/output routines are stored");
        questionC.setRightAnswer("The area where all of the processing takes place");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 6");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question7.class));
                dialog.dismiss();
            }
        });
