...
public class variable_level5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What would be the output of this code ? \n" +
                ...
                " \n" +
                "    }");
        questionC.setAnswer1("8");
        questionC.setAnswer2("8.8");
        questionC.setAnswer3("8.0");
        questionC.setRightAnswer("8.800000095367432");
        ...
        questionBar.setText("");
        level.setText("Variables - Level 5");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("1rowSoftwareQuestions").child("question5").setValue(true);
                reference.child(mAuth.getCurrentUser().getUid()).child("SoftwareAchievement1").setValue(true);
               openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        dialog.setContentView(R.layout.java1_ach_layout);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
