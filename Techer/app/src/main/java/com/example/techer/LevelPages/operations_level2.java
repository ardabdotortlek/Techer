...
public class operations_level2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which of these statements is correct?");
        questionC.setAnswer1("true and false are numeric values 1 and 0");
        questionC.setAnswer2(" true and false are numeric values 0 and 1");
        questionC.setAnswer3(" true is any non zero value and false is 0");
        questionC.setRightAnswer("true and false are non numeric values");
        ...
        questionBar.setText("");
        level.setText("Operations - Level 2");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("2rowSoftwareQuestions").child("question2").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), operations_level3.class));
                dialog.dismiss();
            }
        });
