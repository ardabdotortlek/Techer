...
public class hardware_question13 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which of the following is not an output device?");
        questionC.setAnswer1("Speakers");
        questionC.setAnswer2("Printer");
        questionC.setAnswer3("Monitor");
        questionC.setRightAnswer("Keyboard");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 13");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question14.class));
                dialog.dismiss();
            }
        });
