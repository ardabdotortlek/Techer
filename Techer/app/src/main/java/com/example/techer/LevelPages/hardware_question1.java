...
import com.example.techer.InformationPages.variable_information;
...
public class hardware_question1 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What are the four basic components of a computer?");
        questionC.setAnswer1("Input devices, output devices, printing, and typing");
        questionC.setAnswer2("RAM, ROM , CPU , Motherboard");
        questionC.setAnswer3("Processing unit, Expansion cards, graphics card, sound card");
        questionC.setRightAnswer("Input devices,processing unit, storage, and output devices");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 1");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question2.class));
                dialog.dismiss();
            }
        });
