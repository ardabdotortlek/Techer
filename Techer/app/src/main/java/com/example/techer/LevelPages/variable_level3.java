...
public class variable_level3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which of the following variable descriptor is not a primitive type ?");
        questionC.setAnswer1("char");
        questionC.setAnswer2("boolean");
        questionC.setAnswer3("int");
        questionC.setRightAnswer("string");
        ...
        questionBar.setText("");
        level.setText("Variables - Level 3");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("1rowSoftwareQuestions").child("question3").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), variable_level4.class));
                dialog.dismiss();
            }
        });
