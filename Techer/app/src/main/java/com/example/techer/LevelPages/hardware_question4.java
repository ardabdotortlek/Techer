...
public class hardware_question4 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("The CPU and memory are located on the _________ .");
        questionC.setAnswer1("expansion board");
        questionC.setAnswer2("storage device");
        questionC.setAnswer3("output device");
        questionC.setRightAnswer("motherboard");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 4");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question5.class));
                dialog.dismiss();
            }
        });
