...
public class hardware_question7 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What type of devices allows you to save your file, and then take the file with you to access on a different computer?");
        questionC.setAnswer1("Camera phone or hard drive");
        questionC.setAnswer2("Hard drive or mp3 player");
        questionC.setAnswer3("Floppy disk or hard drive");
        questionC.setRightAnswer("Jumpdrive, floppy disk or memory card");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 7");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question8.class));
                dialog.dismiss();
            }
        });
