...
public class hardware_question3 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Hard disk drives are considered ________ storage.");
        questionC.setAnswer1("flash");
        questionC.setAnswer2("non-permanent");
        questionC.setAnswer3("temporary");
        questionC.setRightAnswer("non-volatile");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 3");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question4.class));
                dialog.dismiss();
            }
        });
