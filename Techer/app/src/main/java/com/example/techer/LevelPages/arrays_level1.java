...
public class arrays_level1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setAnswer1("0");
        questionC.setAnswer2("value stored in arr[0]");
        questionC.setAnswer3("0000");
        questionC.setRightAnswer("Class name@ hashcode in hexadecimal form");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("5rowSoftwareQuestions").child("question1").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), arrays_level2.class));
                dialog.dismiss();
            }
        });
