...
public class hardware_question2 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which of the following is not an input device?");
        questionC.setAnswer1("Mouse");
        questionC.setAnswer2("Keyboard");
        questionC.setAnswer3("Microphone");
        questionC.setRightAnswer("VDU");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 2");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question3.class));
                dialog.dismiss();
            }
        });
