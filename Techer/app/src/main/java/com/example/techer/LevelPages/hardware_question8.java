...
public class hardware_question8 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What does RAM and ROM stand for?");
        questionC.setAnswer1("Random alternate Memory, Real-operating memory");
        questionC.setAnswer2("Real-access memory, Random-output memory");
        questionC.setAnswer3("Read-always memory, Read-only memory");
        questionC.setRightAnswer("Random-access memory, Read-only memory");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 8");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question9.class));
                dialog.dismiss();
            }
        });
