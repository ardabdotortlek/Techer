...
public class loops_level1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What are the three general types of looping structures?");
        questionC.setAnswer1(" infinite loop, counting loop, nested loop");
        questionC.setAnswer2("while loop, for loop, do loop");
        questionC.setAnswer3("count up loop, count down loop, infinite loop");
        questionC.setRightAnswer("counting loop,  sentinel-controlled loop,  and result-controlled loop.");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("4rowSoftwareQuestions").child("question1").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), loops_level2.class));
                dialog.dismiss();
            }
        });
