...
public class operations_level4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("What is the output of the Java code snippet? \\n\" +\n" +
                "                        \"byte a = 0b0000_0001;\\n\" +\n" +
                "                        \"System.out.println(~a);");
        questionC.setAnswer1("-1");
        questionC.setAnswer2("254");
        questionC.setAnswer3("127");
        questionC.setRightAnswer("-2");
        ...
        questionBar.setText("");
        level.setText("Operations - Level 4");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("2rowSoftwareQuestions").child("question4").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), operations_level5.class));
                dialog.dismiss();
            }
        });
