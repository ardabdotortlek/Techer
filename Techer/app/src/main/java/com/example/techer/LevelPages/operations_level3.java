...
public class operations_level3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which is the Logical operator in Java that works with a Single Operand?");
        questionC.setAnswer1("Logical AND");
        questionC.setAnswer2("Logical OR");
        questionC.setAnswer3("Logical Exclusive OR");
        questionC.setRightAnswer("Logical NOT");
        ...
        questionBar.setText("");
        level.setText("Operations - Level 3");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("2rowSoftwareQuestions").child("question3").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), operations_level4.class));
                dialog.dismiss();
            }
        });
