...
public class hardware_question12 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which adapter card is used to display images or videos to any display devices such as a monitor?");
        questionC.setAnswer1("Credit Card");
        questionC.setAnswer2("Network Card");
        questionC.setAnswer3("Sound Card");
        questionC.setRightAnswer("Video Card");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 12");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question13.class));
                dialog.dismiss();
            }
        });
