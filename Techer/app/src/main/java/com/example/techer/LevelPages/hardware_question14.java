...
public class hardware_question14 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which device allows your computer to talk to other computers over a telephone line as well as access the internet?");
        questionC.setAnswer1("Hard Drive");
        questionC.setAnswer2("RAM");
        questionC.setAnswer3("CD-ROM drive");
        questionC.setRightAnswer("Modem");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 14");
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), hardware_question_final.class));
                dialog.dismiss();
            }
        });
