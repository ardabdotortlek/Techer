...
public class hardware_question10 extends AppCompatActivity implements View.OnClickListener {
    TextView level;
    TextView question;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("The central processing unit contains which of the following as a component?");
        questionC.setAnswer1(" Instruction Manipulation Unit");
        questionC.setAnswer2("Flow Control Unit");
        questionC.setAnswer3("Memory Regulation Unit");
        questionC.setRightAnswer("Arithmetic Logic Unit");
        ...
        questionBar.setText("");
        level.setText("Hardware Question 10");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()){
                reference.child(mAuth.getCurrentUser().getUid()).child("HardwareAchievement10").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        dialog.setContentView(R.layout.hardware_ach_2);
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
