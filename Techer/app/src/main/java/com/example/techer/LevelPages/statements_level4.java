...
public class statements_level4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionC.setTheQuestion("Which of this statement is incorrect?");
        questionC.setAnswer1("it is possible to create a nested switch statements");
        questionC.setAnswer2("switch statement is more efficient than a set of nested ifs");
        questionC.setAnswer3("switch statement can only test for equality, whereas if statement can evaluate any type of boolean expression");
        questionC.setRightAnswer("two case constants in the same switch can have identical values");
        ...
        choice1.setTextSize(10);
        choice2.setTextSize(10);
        choice3.setTextSize(10);
        choice4.setTextSize(10);
        ...
        questionBar.setText("");
        level.setText("Statements - Level 4");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.choice1){
            if (choice1.getText() == questionC.getRightAnswer()) {
                reference.child(mAuth.getCurrentUser().getUid()).child("3rowSoftwareQuestions").child("question4").setValue(true);
                openWinDialog();
            }
            else
                openLoseDialog();
    ...
    private void openWinDialog() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), statements_level5.class));
                dialog.dismiss();
            }
        });
